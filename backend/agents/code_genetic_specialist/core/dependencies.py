"""
Dependencies injection container for CODE Genetic Specialist.
...
class AgentDependencies:
    """
    Dependency injection container for CODE Genetic Specialist.
    ...
    adapters. This pattern enables better testing and modularity.
    """
...
def create_dependencies() -> AgentDependencies:
    """
    Factory function to create AgentDependencies with default implementations.

    Returns:
        AgentDependencies: Configured dependencies container
    ...
    try:
        ...
        raise RuntimeError(f"Failed to create dependencies: {e}")
