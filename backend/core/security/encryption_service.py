...
from core.security.secrets_manager import SecretKeys, get_secret
...
class EncryptionService:
    ...
    def _load_or_generate_key(self) -> bytes:
        ...
        if os.getenv("ENV", "development") == "development":
            logger.info(
                f"Generated encryption key (base64): {base64.b64encode(key).decode()}"
            )
    ...
    def decrypt_string(
        self, ciphertext_b64: str, associated_data: Optional[str] = None
    ) -> str:
        """
    ...
    def encrypt_fields(
        ...
        for field in fields_to_encrypt:
            if field in result and result[field] is not None:
                ...
                # Store encrypted value with marker and integrity check
