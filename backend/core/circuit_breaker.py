...
class CircuitBreakerManager:
    ...
    def get_instance(cls) -> "CircuitBreakerManager":
        """Get singleton instance of CircuitBreakerManager."""
        if cls._instance is None:
            cls._instance = cls()
        return cls._instance
    
    def initialize_default_breakers(self) -> None:
        """Initialize default circuit breakers for the system."""
        ...
        self.register(vertex_ai_breaker)
        ...
        self.register(supabase_breaker)
        ...
        self.register(external_api_breaker)
        
        logger.info(f"Initialized {len(self._breakers)} default circuit breakers")
